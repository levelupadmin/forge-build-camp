...
const builders: Builder[] = [
  ...
  },
  {
    ...
    walkedIn: "Second-generation of a family luxury travel business, already building automations and simple AI apps on her own, but every win was individual and none added up to a single view of the business.",
  ...
  },
  {
    ...
    walkedIn: "Two decades in traditional consulting in North America, having quietly built multi-agent systems and complex AI harnesses on his own, but no systematic pattern to package what he had learned.",
