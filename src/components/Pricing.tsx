...
const inclusions = [
  "9-day residential stay in Dharamshala",
  "All accommodation included",
  "All meals for 9 days included",
  "Full access to all 3 pillar sessions",
  "Daily mentor feedback sessions",
  "Online prep program, 4 to 5 days before",
    ...
    <SectionWrapper label="THE INVESTMENT">
      ...
      <div className="max-w-[520px] mx-auto glass-card p-8 border-[rgba(240,165,0,0.35)] shadow-[0_0_48px_rgba(240,165,0,0.07)]">
        <div className="text-center mb-6">
          <span className="font-mono text-[11px] text-primary tracking-wider">COHORT 01 &middot; ALL INCLUSIVE</span>
          <p className="font-syne font-[800] text-[60px] md:text-[68px] text-foreground mt-2 leading-none">₹1,20,000</p>
