...
const faqs = [
  ...
  { q: "What is the AI Perks Vault — are the credits really free?", a: "Yes. 220 real perks across AWS, Claude, OpenAI, Vercel, Stripe, and more — total face value of $7.74M+. You apply through the Forge dashboard; each perk has its own eligibility, which we've graded with an approval index so you know what's realistic. We don't pool or resell — every credit stays on your account." },
