  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onOpenModal}
          className="group mt-10 inline-flex items-center gap-2.5 bg-[#1A6AFF] text-white font-semibold rounded-full px-8 py-3.5 text-sm uppercase tracking-wider btn-glow"
        >
          Request an invite
