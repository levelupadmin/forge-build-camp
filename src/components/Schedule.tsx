...
const days: ScheduleDay[] = [
  {
    key: "prep",
    label: "ONLINE PREP",
    subtitle: "Five sessions before you travel — Sept 5–9",
    image: imgOnlinePrep,
    rows: [
      { icon: BookOpen, time: "Sept 5  ·  7:30–9:00 PM", title: "Session 1 — Orientation", sub: "Welcome to the Forge. Get every tool live: Claude, Claude Code, n8n, Supabase, Vercel. Build your second brain." },
      { icon: BookOpen, time: "Sept 6  ·  2:00–4:00 PM", title: "Session 2 — Product Thinking Fundamentals", sub: "The AI-shaped problem filter, validating the idea, and the build spec that becomes your blueprint. With Ankur." },
      { icon: BookOpen, time: "Sept 7  ·  7:00–9:00 PM", title: "Session 3 — Design Fundamentals", sub: "Visual hierarchy, layout, type and colour. What makes a product feel trustworthy." },
      { icon: Workflow, time: "Sept 8  ·  7:30–9:30 PM", title: "Session 4 — Automation & Workflows 101", sub: "Triggers, steps, the think-act-observe loop. With Parth." },
      { icon: FileCheck2, time: "Sept 9  ·  7:00–9:00 PM", title: "Session 5 — Review & Align (1-on-1)", sub: "Present your build brief, get live mentor feedback, leave with a locked plan." },
    ],
  },
  {
    key: "d1",
  ...
  },
  {
    ...
    image: imgDays23,
    rows: [
      { icon: Users, time: "9:00 AM", title: "Morning Standup" },
      { icon: Sparkles, time: "9:15 AM – 11:15 AM", title: "How LLMs Actually Work + The ₹999 Problem-Framing Test" },
      { icon: Sparkles, time: "11:15 AM – 12:30 PM", title: "System Design Without Code + Write Your Spec" },
      { icon: UtensilsCrossed, time: "12:30 PM – 1:30 PM", title: "Lunch" },
      { icon: Sparkles, time: "1:30 PM – 6:00 PM", title: "Claude Code + Your First MCP Tool — with Ankur" },
  ...
  },
  {
    ...
    rows: [
      { icon: Users, time: "9:00 AM", title: "Morning Standup" },
      { icon: Rocket, time: "9:15 AM – 12:30 PM", title: "Production Architecture: UI, Postgres, Auth, RLS, Edge Functions" },
      { icon: UtensilsCrossed, time: "12:30 PM – 1:30 PM", title: "Lunch" },
      { icon: Rocket, time: "1:30 PM – 5:00 PM", title: "Messages API · Streaming · Prompt Caching · Webhooks + Payments" },
      { icon: FileCheck2, time: "5:00 PM – 7:00 PM", title: "Ship #1 Live + Build Your Eval Scorecard — with Ankur" },
      { icon: UtensilsCrossed, time: "7:00 PM", title: "Dinner + Build Night" },
    ],
  },
  {
    ...
    rows: [
      { icon: Users, time: "9:00 AM", title: "Morning Standup" },
      { icon: Workflow, time: "9:15 AM – 12:30 PM", title: "Automation Thinking + AI Agents in n8n (brain, memory, tools)" },
      { icon: UtensilsCrossed, time: "12:30 PM – 1:30 PM", title: "Lunch" },
      { icon: Workflow, time: "1:30 PM – 5:00 PM", title: "Build a Ticket-Classifying Support Agent" },
      { icon: Workflow, time: "5:00 PM – 7:00 PM", title: "Connect Your Apps with MCP + Build Your Personal AI Assistant — with Parth" },
      { icon: UtensilsCrossed, time: "7:00 PM", title: "Dinner + Build Night" },
    ],
  },
  {
    ...
    rows: [
      { icon: Users, time: "9:00 AM", title: "Morning Standup" },
      { icon: Workflow, time: "9:15 AM – 12:30 PM", title: "Browser Agents + Claude Cowork" },
      { icon: UtensilsCrossed, time: "12:30 PM – 1:30 PM", title: "Lunch" },
      { icon: Workflow, time: "1:30 PM – 4:00 PM", title: "Ground Agents in Your Docs (RAG)" },
      { icon: Workflow, time: "4:00 PM – 7:00 PM", title: "Voice Agents for Outbound Calling + Protected 1:1s — with Parth" },
      { icon: UtensilsCrossed, time: "7:00 PM", title: "Dinner + Build Night" },
    ],
  },
  {
    ...
    rows: [
      { icon: Users, time: "9:00 AM", title: "Morning Standup" },
      { icon: Workflow, time: "9:15 AM – 12:30 PM", title: "Design a Full Business Process · Multi-Agent Orchestration · Human-in-the-Loop" },
      { icon: UtensilsCrossed, time: "12:30 PM – 1:30 PM", title: "Lunch" },
      { icon: Workflow, time: "1:30 PM – 4:30 PM", title: "Build an Invoice & Payment Assistant" },
      { icon: Sparkles, time: "4:30 PM – 7:30 PM", title: "Outdoor Hackathon + Golden-Hour Showcase" },
      { icon: UtensilsCrossed, time: "7:30 PM", title: "Dinner + Build Night" },
    ],
  },
  {
    key: "d7",
    ...
    rows: [
      ...
      { icon: Rocket, time: "9:00 AM – 12:30 PM", title: "Demo Day — 8 minutes each, no slides, real working demo" },
      { icon: PartyPopper, time: "12:30 PM – 1:30 PM", title: "Farewell + 90-Day Roadmap Commitments" },
